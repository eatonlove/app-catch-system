...
VERSION='opportunity-directions-v3'
COMMON='''研究目标：为已有中国及美国 App Store、Google Play、国内安卓与鸿蒙开发者账号的小团队寻找值得验证的应用机会。优先考虑无需政府专项审批的具体功能；账号拥有不等于业务资质齐全。
只使用提供的证据。不把排名、价格、评分数当成收入、付费用户数、付费率或留存。收入估算不称实收，日流水不称订阅MRR。缺少某市场样本不证明当地没有竞品；不比较不同渠道的绝对名次。同一天多个产品上榜只能说明榜单内有同类供给，不能写成持续需求、需求旺盛或付费意愿强。保留评分数与评论数各自的原始口径。缺评论、关键词、历史序列、功能说明或政策来源时明确列出缺口，不虚构搜索或网页调查。
参考用户既有SOP中的“人群+诉求+场景”“需求/流量/变现交叉验证”“差评拆解”“7—14天MVP实验”；不沿用未经验证的固定指数阈值、安卓收入倍数或开发周期保证。
输出中文，最多3个待验证机会线索，按证据强度和可验证性排序。即使只有一天榜单，也可从已有应用的任务和类别提出差异化假设；明确这些不是增长已证实或盈利已证实的机会。每项task说明人群与任务；hypothesis用分段文本依次写【已知证据】【机会假设】【差异化切口】【变现与获客验证】【资质待查】【最小实验及停止条件】。不得为了凑数制造证据；确实无法提出时说明具体原因。每项引用证据ID，并列出会推翻判断的未知项。summary说明本次能回答和不能回答什么；data_gaps和next_steps给出可执行补采/验证方案。所有建议是研究优先级，不是收益预测或开发批准。'''
DIRECTIONS=[
 ...
 {'id':'midmarket','title':'中腰部稳定经营','description':'检验多个独立小产品的持续商业支持。','prompt':'按独立开发商和任务分组，寻找中腰部长期存活与变现证据。不可从单日畅销榜推出持续经营；没有日收入和独立开发商核验则生成补证任务。'},
 {'id':'new-products','title':'新产品快速验证','description':'区分真正新品、换包和小基数跳升。','prompt':'结合首次上架、版本、开发商历史和短期经营数据提出新品任务假设；未提供上架时间不得自行判断新品。标注低基数与观察窗。'},
 {'id':'migration','title':'版本变化与用户迁移','description':'从提价、删功能及不兼容变化寻找替代窗口。','prompt':'比对版本/价格变动前后独立评论与迁移诉求；评论自称付费只是弱证据。没有原文与时间对照不得编造删功能、提价或流失。'},
 {'id':'cross-store','title':'同地区跨系统迁移','description':'优先验证同地区安卓、iOS、鸿蒙任务缺口。','prompt':'以相同地区用户任务为对象，核验系统自带、Web替代品和平台API能力。未采集目标市场不等于没有竞品；列至少5个检索表达与前20结果核验计划。'},
 {'id':'workflow','title':'人工工作流工具化','description':'将重复表格、多工具拼接和人工服务变成单任务产品。','prompt':'从访谈、工作流原文寻找已付出的时间/金额与重复频率，明确谁在什么情景完成何任务。只有榜单时仅提出访谈问题，不编造工作流。'},
 {'id':'cost-change','title':'成本结构变化','description':'核验新技术是否降低交付成本并形成可维护切口。','prompt':'列明旧交付成本、新技术成本与平台依赖，分保守/基准/乐观情景。没有成本资料不能断言成本降低；检查被平台内置的反证。'},
